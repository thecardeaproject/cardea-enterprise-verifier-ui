...
export default function (state = initialState, action) {
    ...
    switch (action.type) {
      ...
      case LOGOUT_USER:
        return initialState
      //there must always be a default case, I add it on the the reducer when i write it the first time so its always there. If the default value doesn't touch any of these cases, it will not break the redux.
      default:
        return state
    }
  }